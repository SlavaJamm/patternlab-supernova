    ...
    angular.module('sfMediaField', ['sfServices'])
        .service("sfMediaTypeResolver", ['sfMediaService', 'serverContext', function (sfMediaService, serverContext) {
            ...
            var Videos = function () {
                ...
                this.getDefaultTemplateUrl = function () {
                    return serverContext.getEmbeddedResourceUrl('Arekibo.Neptune.Widgets', 'client-components/fields/video-field/sf-video-field.sf-cshtml');
                };
            };
        ...
        function (serverContext, sfMediaService, sfMediaFilter, sfMediaTypeResolver, serverData) {
            return {
                ...
                link: function (scope, element, attrs, ctrl) {
                    ...
                    scope.changeMedia = function ($event) {
                        scope.model = {
                            selectedItems: [],
                            filterObject: null,
                        ...
                        if (id) {
                            var el = document.getElementById(id).querySelector('.mediaSelectorModal');
                            if (el) {
